...
@Component({
    selector: "used-product-card", // this is the element name: <site-header></site-header>
    templateUrl: "used-product-card.html", // a path to this component's .html file relative to the directory of the current file. (usually same directory, so only file name)
})
export class usedProductCard { // export makes this class available to other classes who import it.
    // Code goes here.
