...
@Component({
    selector: "checkout", // this is the element name: <site-header></site-header>
    templateUrl: "checkout.html", // a path to this component's .html file relative to the directory of the current file. (usually same directory, so only file name)
})
export class checkout { // export makes this class available to other classes who import it.
    // Code goes here.
