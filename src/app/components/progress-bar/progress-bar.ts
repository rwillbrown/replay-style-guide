...
@Component({
    selector: "progress-bar", // this is the element name: <site-header></site-header>
    templateUrl: "progress-bar.html", // a path to this component's .html file relative to the directory of the current file. (usually same directory, so only file name)
})
export class progressBar { // export makes this class available to other classes who import it.
    // Code goes here.
