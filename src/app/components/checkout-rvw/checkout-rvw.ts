...
@Component({
    selector: "checkout-rvw", // this is the element name: <site-header></site-header>
    templateUrl: "checkout-rvw.html", // a path to this component's .html file relative to the directory of the current file. (usually same directory, so only file name)
})
export class checkoutRvw { // export makes this class available to other classes who import it.
    // Code goes here.
